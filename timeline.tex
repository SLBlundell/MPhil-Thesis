...
\caption{Within-period sequence of events by agent, with nodes denoting actions undertaken by a respective agent type within the given sub-period. Labels (a)--(e) correspond to those above.}
\label{fig:timeline}
\end{figure}