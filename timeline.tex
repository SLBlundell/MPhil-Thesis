...
\node[agentlbl] at (0.3, \yL) {International Lender};
...
\end{tikzpicture}
\caption{Within-period sequence of events by agent. Labels (a)--(e) correspond to those in Section~\ref{sec:timings}.}
\label{fig:timeline}
\end{figure}